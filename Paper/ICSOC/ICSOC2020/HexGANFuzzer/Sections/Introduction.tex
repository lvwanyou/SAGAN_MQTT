...
%in which it can intelligently learn to generate testing data by itself.
...
%\textcolor[rgb]{1,0,0}{Judge this part exist or not: Moreover, in the process of sampling, this paper introduces a series of anti-random strategies to improve the probability of anomalies throwing}
...
The remainder of this paper is organized as follows. Section \uppercase\expandafter{\romannumeral2} discusses the related work. Section \uppercase\expandafter{\romannumeral3} details the optimized improved SAGAN algorithm and the entire methodology design. Section \uppercase\expandafter{\romannumeral4} presents the performance metrics that we propose. Section \uppercase\expandafter{\romannumeral5} presents the experiment and evaluation results. Section \uppercase\expandafter{\romannumeral6} concludes the paper and discusses some ideas about future work.
